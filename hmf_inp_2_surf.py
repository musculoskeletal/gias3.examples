...
parser.add_argument(
    ...
    help='Initial Eulerian rotations to apply to the source surface to align it with the target surface. In radians.'
    )
parser.add_argument(
    '-v', '--view',
    action='store_true',
...
init_rot = args.rotate #[-np.pi/2, 0, 0]
...
source_mesh, source_header = _load_inp(sourceFilename)
